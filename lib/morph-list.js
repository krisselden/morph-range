...
function updateMountedMorph(morphList, morph, referenceMorph) {
  ...
  if (morph.previousMorph === null) {
    mountedMorph.firstNode = morph.firstNode;
  }

  if (morph.nextMorph === null) {
    mountedMorph.lastNode = morph.lastNode;
  }
}
...
prototype.removeChildMorph = function MorphList$removeChildMorph(morph) {
  ...
  console.log(previousMorph, nextMorph, mountedMorph);
  ...
  if (previousMorph) {
    ...
    this.firstNode = nextMorph && nextMorph.firstNode;
  }
  ...
  if (nextMorph) {
    ...
    this.lastNode = nextMorph && nextMorph.lastNode;
  }
