...
Morph.prototype.setNode = function Morph$setNode(newNode) {
  ...
  if (previousFirstNode !== firstNode &&
      this.parentMorph &&
      this.parentMorph.firstChildMorph === this) {
    updateFirstNode(this.parentMorph, firstNode);
  }

  if (lastNode !== this.lastNode &&
      this.parentMorph &&
      this.parentMorph.lastChildMorph === this) {
...
Morph.prototype.insertBeforeMorph = function(morph, referenceMorph) {
  ...
  insertBefore(parentNode, morph.firstNode, morph.lastNode, referenceMorph ? referenceMorph.firstNode : null);
  ...
  var parentMorph;
  var firstNode = this.firstChildMorph.firstNode;
  var lastNode = this.lastChildMorph.lastNode;

  if (this.firstNode !== firstNode) {
    parentMorph = this;
    do {
      parentMorph.firstNode = firstNode;
      parentMorph = parentMorph.parentMorph;
    } while (parentMorph);
  }

  if (this.lastNode !== lastNode) {
    parentMorph = this;
    do {
      parentMorph.lastNode = lastNode;
      parentMorph = parentMorph.parentMorph;
    } while (parentMorph);
  }
};
